...
void write_results(int results_number, Result **naive_results, Result **smart_results, lxw_workbook *file, lxw_worksheet *sheet) {
	...
	//chart_series_set_trendline(naive, LXW_CHART_TRENDLINE_TYPE_POWER, 0); linea di tendenza
	...
	//chart_series_set_trendline(smart, LXW_CHART_TRENDLINE_TYPE_LINEAR, 0); linea di tendenza
